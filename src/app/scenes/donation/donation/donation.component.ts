...
export class DonationComponent implements OnInit {
    ...
    constructor(private router: Router, private stripeService: AngularStripeService, private route: ActivatedRoute, public loader: LoadingService, private http: HttpClient, private notificationService: NotificationService, private translate: TranslateService) {
    ...
    ngOnInit(): void {
        ...
        // Once api returns payment provider, enable this here
        //this.paymentProvider = this.route.snapshot.data['paymentProvider'];
