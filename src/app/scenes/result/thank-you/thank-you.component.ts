...
export class ThankYouComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        this.organisationThankYou = localStorage
            .getItem('organisationThankYou')!
            .substring(0, 175);
    ...
    ngOnInit(): void {
        ...
        mixpanel.track('page_load', {
            page: 'success_page',
            organisationName: this.param.organisationName,
        });
    }
    ...
    sendEmail($event: string) {
        ...
        this.http
            .post(
                environment.apiUrl +
                    '/api/report/singleDonation?email=' +
                    $event,
                null,
